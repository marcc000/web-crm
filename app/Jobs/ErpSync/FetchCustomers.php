    ...
    public function handle(): void
    {
        $query = DB::connection('erp')
            ...
            ->select(
                ...
                'BPC.BPAADD_0 as default_address_id',
                'BPC.BPDADD_0 as default_delivery_address_id',
                'BPC.CNTNAM_0 as default_contact_id',
        ...
        foreach ($customers as $customer) {
            Customer::upsert(
                [
                    ...
                    'default_contact_id' => $customer->default_contact_id,
                    ...
                    'default_delivery_address_id' => $customer->default_delivery_address_id,
